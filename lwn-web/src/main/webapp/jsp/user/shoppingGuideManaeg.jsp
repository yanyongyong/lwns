...
<table id="dg" title="导购员信息" style="width:100%;height: 520px;" class="easyui-datagrid"
       data-options="rownumbers:true,singleSelect:true,pagination:true,url:'/user/dimselectGuide',method:'post'">
    <thead>
    <tr>
...
<script type="text/javascript">
    ...
    function newUser() {
        ...
        url = '/user/insertShoppingGuide'; //保存用户的url
    }
    function editUser() {
...
<div id="editDlg" class="easyui-dialog"
    ...
    <form id="deit" method="post" novalidate>
        ...
        <div class="fitem" style="display:none;">
            <label> 备注: </label> <input name="lastUpdate"
                                        class="easyui-validatebox textbox">
        </div>
...
<div style="background:red; display: none;width:200px; height: 25px; line-height: 25px; text-align: center; position: absolute; left: 50%; top:0; margin-left: -100px;">
    ${sessionScope.shoppingGuideResult}
</div>
