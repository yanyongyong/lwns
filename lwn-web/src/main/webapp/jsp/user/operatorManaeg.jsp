...
<table id="dg" title="操作员信息" style="width:100%;height: 520px;" class="easyui-datagrid"
       data-options="rownumbers:true,singleSelect:true,pagination:true,url:'/user/dimselectOperator',method:'post'">
    <thead>
    <tr>
...
<script type="text/javascript">
    ...
    function newUser() {
        ...
        url = '/user/insertOperator'; //保存用户的url
    }
    function editUser() {
