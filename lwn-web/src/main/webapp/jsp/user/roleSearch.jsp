...
<table id="dg" title="用户信息" style="width:100%;height: 420px;" class="easyui-datagrid"
       data-options="rownumbers:true,singleSelect:true,pagination:true,url:'/user/dimSelectAll',method:'post'">
    <thead>
    <tr>
        <th data-options="field:'userId',width:90">编号</th>
        <th data-options="field:'userRole',width:120">角色</th>
        <th data-options="field:'userName',width:110">姓名</th>
        <th data-options="field:'password',width:130">密码</th>
        <th data-options="field:'phoneNum',width:130">电话号码</th>
        <th data-options="field:'lastUpdate',width:186">注册时间</th>
    ...
    function saveUser() {
        ...
        if (title == '搜索') {
            ...
            $('#dg').datagrid('load', {
                ...
                userRole: $('#search input[name="userRole"]').val().trim(),
            });
        }
...
<div id="dlg" class="easyui-dialog"
    ...
    <form id="fm" method="post" novalidate>
        ...
        <div class="fitem">
            <label> 角色: </label>
            <select class="easyui-combogrid" name="userRole" style="width:130px" data-options="
			panelWidth: 220,
			idField: 'roleName',
			textField: 'roleName',
			url: '/role/dimSelectRole?page=1&rows=50',
			method: 'post',
			columns: [[
...
<div id="searchDlg" class="easyui-dialog"
    ...
    <form id="search" method="post" novalidate>
        ...
        <div class="fitem">
            <label> 角色: </label> <input name="userRole" class="easyui-validatebox">
        </div>
        ...
        <div class="fitem" style="display: none;">
            <label> 注册时间: </label> <input name="lastUpdate"
                                        class="easyui-validatebox">
        </div>
