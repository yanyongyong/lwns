...
<table id="dg" title="权限信息" style="width:100%;height: 520px;" class="easyui-datagrid"
    ...
    <thead>
    <tr>
        <th data-options="field:'memberId',width:120">会员编号</th>
        <th data-options="field:'memberName',width:120">会员名称</th>
        <th data-options="field:'memberIntegral',width:200,">积分</th>
        <th field="grade.gradeName" width="120" data-options="formatter:function(value,r){return r.grade['gradeName']}">等级</th>
        <th data-options="field:'memberPhone',width:200">电话号码</th>
