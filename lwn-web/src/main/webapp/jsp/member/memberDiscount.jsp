...
<table id="dg" title="权限信息" style="width:100%;height: 520px;" class="easyui-datagrid"
    ...
    <thead>
    <tr>
        <th data-options="field:'gradeId',width:200">等级编号</th>
        <th data-options="field:'gradeName',width:200">等级名称</th>
        <th data-options="field:'integralDiscount',width:200,">会员折扣</th>
...
<div id="editDlg" class="easyui-dialog"
    ...
    <form id="deit" method="post" novalidate>
        ...
        <div class="fitem">
            <label> 会员折扣: </label> <input name="integralDiscount" class="easyui-validatebox textbox"
                                        data-options="required:true">
        </div>
